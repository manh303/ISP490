      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            A comprehensive solution supporting intelligent decision-making for modern businesses.
          </p>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <a href="#" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '14px' }}>Solutions</a>
            <a href="#" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '14px' }}>About Us</a>
