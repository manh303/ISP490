...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | DSS - React.js Admin Dashboard Template"
        description="This is React.js Videos page for DSS - React.js Tailwind CSS Admin Dashboard Template"
      />
