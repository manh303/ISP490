...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | DSS - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for DSS - React.js Tailwind CSS Admin Dashboard Template"
      />
