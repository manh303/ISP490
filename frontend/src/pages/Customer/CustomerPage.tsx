  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50/30 to-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-gray-200">
              <div>
                <p className="text-green-600 mb-1">5,000+</p>
                <p className="text-gray-600">Người bán</p>
              </div>
              <div>
                <p className="text-green-600 mb-1">+45%</p>
                <p className="text-gray-600">Tăng doanh thu</p>
              </div>
              <div>
                <p className="text-green-600 mb-1">24/7</p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 border-2 border-gray-100">
              ...
              {/* Floating Cards */}
              <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-xl p-4 border-2 border-green-100">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            <div>
              ...
              <p className="text-green-100">Người bán tin dùng</p>
            </div>
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-green-100">Tăng trưởng TB</p>
            </div>
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-green-100">Đơn hàng phân tích</p>
            </div>
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-green-100">Độ chính xác</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-green-50">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto bg-gradient-to-br from-green-500 to-blue-600 text-white border-none shadow-2xl">
